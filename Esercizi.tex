...
\end{eser}\index{Frequenza!percentuale}
\begin{eser}
...
\end{eser}\index{Frequenza!cumulata}
\begin{eser}
...
\end{eser}\index{Media}\index{Scarto}
\begin{eser}
...
\end{eser}\index{Media}\index{Scarto!quadratico}
\begin{eser}
...
\end{eser}\index{Moda}\index{Media}\index{Mediana}
\begin{eser}
