...
\begin{soluzione}
	...
	\begin{tabular}{ll}
		...
		\bottomrule
	\end{tabular}
\subcaption{Frequenze assolute}\label{EsercizioUnoA}
	\end{subtable}
	\centering0°
	\begin{subtable}[b]{.4\linewidth}
	\begin{tabular}{lll}
		\toprule
		\multicolumn{1}{c}{X} & \multicolumn{1}{c}{n} & \multicolumn{1}{c}{Fr}\\
		\midrule
		150 & 1 & $\frac{1}{24}$ \\
		151 &1&$\frac{1}{24}$ \\
		152 &1&$\frac{1}{24}$ \\
		...
		\bottomrule
	\end{tabular}
\subcaption{Frequenze relative}\label{fig:EsercizioUnoB}
\end{subtable}
	\begin{subtable}[b]{.4\linewidth}
	\begin{tabular}{llll}
		\toprule
		...
		\midrule
		150 & 1&1&$\frac{1}{24}$&\MyNum{4.166666667} \\
		151 &1&1&$\frac{1}{24}$&\MyNum{4.166666667} \\
		152 &1&1&$\frac{1}{24}$&\MyNum{4.166666667} \\
		156 &2&2&$\frac{2}{24}$&\MyNum{8.333333333} \\
		160 &1&1&$\frac{1}{24}$&\MyNum{4.166666667} \\
		161 &1&1&$\frac{1}{24}$&\MyNum{4.166666667} \\
		164 &1&1&$\frac{1}{24}$&\MyNum{4.166666667} \\
		166 &2&2&$\frac{2}{24}$&\MyNum{8.333333333} \\
		168 &1&1&$\frac{1}{24}$&\MyNum{4.166666667} \\
		169 &2&2&$\frac{2}{24}$&\MyNum{8.333333333} \\
		170 &1&1&$\frac{1}{24}$&\MyNum{4.166666667} \\
		172 &3&2&$\frac{3}{24}$&\MyNum{12.5} \\
		174 &2&2&$\frac{2}{24}$&\MyNum{8.333333333} \\
		175 &1&1&$\frac{1}{24}$&\MyNum{4.166666667} \\
		178 &1&1&$\frac{1}{24}$&\MyNum{4.166666667} \\
		179 &1&1&$\frac{1}{24}$&\MyNum{4.166666667} \\
		180 &1&1&$\frac{1}{24}$&\MyNum{4.166666667} \\
		\midrule
		Tot.&24&1&100\\
		\bottomrule
	\end{tabular}
	\subcaption{Frequenze percentuali}\label{fig:EsercizioUnoB}
\end{subtable}
