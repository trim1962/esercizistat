...
\end{subtable}
	...
	\begin{tabular}{ll>{\xstrut$}l <{$}l}
		...
		x & n & Fr&F\%\\
		\midrule
		150 &1&\frac{3} {27}&\MyNum{11.111111111} \\
		...
		169 &2&\frac{3} {27}&\MyNum{11.111111111} \\
		170 &1&\frac{1} {27}&\MyNum{4.166666667} \\
		172 &3&\frac{4} {27}&\MyNum{14.81481481} \\
...
\begin{subtable}[t]{.4\linewidth}
	...
	\begin{tabular}{lll}
		...
		\bottomrule
	\end{tabular}
\subcaption{Frequenze prima classe}\label{Tab:EsercizioDueA}	
\end{subtable}
\begin{subtable}[t]{.4\linewidth}
	\centering
	\begin{tabular}{lll}
		\toprule
		V	& n & F\% \\
		1	& 2 & \MyNum{0.111111111}\\
		2	& 5 & \MyNum{0.111111111}\\
		3	& 3 &\MyNum{0.148148148}\\
		4	&4 & \MyNum{0.037037037}\\
		5	&3 & \MyNum{0.037037037}\\
		6	& 7 & \MyNum{0.111111111}\\
		7	& 4 & \MyNum{0.222222222}\\
		8	& 2 & \MyNum{0.185185185}\\
		9	&2 & \MyNum{0.037037037}\\
		10	& 1 & \MyNum{0.0}\\
		\midrule
		Tot.& 27 & \MyNum{100.0} \\
		\bottomrule
	\end{tabular}
	\subcaption{Frequenze seconda classe}\label{Tab:EsercizioDueB}	
\end{subtable}	
\captionsetup{labelformat=empty}
